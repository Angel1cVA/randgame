...
while start == 1:
	...
	#Use above line next to L-Star if you want Care Package Weapons in the pool
		...
		print('Your race is ' + random.choice(list(Skyrim.get('Race'))) + ' with a M/H/S point array of ' + random.choice(list(Skyrim.get('Magika'))) + '/' + random.choice(list(Skyrim.get('Health'))) + '/' + random.choice(list(Skyrim.get('Stamina'))) + ' under the Blessing of ' + random.choice(list(Skyrim.get('Blessing'))) + ' and your main skills will be ' + random.choice(list(Skyrim.get('CSkill'))) + ', ' + random.choice(list(Skyrim.get('CSkill'))) + ', ' + random.choice(list(Skyrim.get('MSkill'))) + ', ' + random.choice(list(Skyrim.get('MSkill'))) + ', ' + random.choice(list(Skyrim.get('SSkill'))) + ', ' + random.choice(list(Skyrim.get('SSkill'))) + '.')
	...
	if answer.upper() == 'Y':
		...
		print("Let's play agaon sometime!")
		start = start + 1
	else:
