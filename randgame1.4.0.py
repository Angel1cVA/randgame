#Code made by Liam Parker (@realangel1c55 on Instagram, @randDev55 on Twitter), please credit the creator if .
...
while start == 1:
	...
	if gameName == 1:
		...
		Apex = {
			'Legends': ['Bloodhound' , 'Gibralter' , 'Lifeline' , 'Wraith' , 'Pathfinder' , 'Bangalore' , 'Caustic' , 'Mirage' , 'Octane' , 'Wattson' , 'Crypto' , 'Revenant' , 'Loba' , 'Rampart' , 'Horizon' , 'Fuze' , 'Valkerie' , 'Seer' , 'Ashe' , 'Mad Maggie' , 'Newcastle' , 'Vantage' , 'Catalyst'],
			'Guns': ['Fists' , 'Grenades' , 'P2020' , 'Mozambique' , 'Wingman' , 'Peacekeeper' , 'EVA-8' , 'Mastiff' , 'Flatline' , 'R-301' , 'HAVOC' , 'Hemlock' , 'R-99' , 'Prowler' , 'Volt' , 'CAR' , 'G7 Scout' , 'Triple Take' , '3030 Repeater' , 'Charge Rifle' , 'Longbow DMR' , 'Sentinel' , 'Devotion' , 'Spitfire' , 'L-STAR']
			}

	#, 'Kraber' , 'RE-45' , 'Bochec Compound Bow' , 'Rampage'
	#Use above line next to L-Star if you want Care Package Weapons in the pool
		...
		Overwatch2 = {
			'Heroes': ['D. Va' , 'Doomfist' , 'Junker Queen' , 'Orisa' , 'Reinhardt' , 'Roadhog' , 'Sigma' , 'Winston' , 'Wrecking Ball' , 'Zarya' , 'Ana' , 'Baptiste' , 'Briggite' , 'Kiriko' , 'Lucio' , 'Mercy' , 'Moira' , 'Zenyatta' , 'Ashe' , 'Bastion' , 'Echo' , 'Genji' , 'Hanzo' , 'Junkrat' , 'Cassidy (McCree)' , 'Mei' , 'Phara' , 'Reaper' , 'Sojourn' , 'Soldier: 76' , 'Sombra' , 'Symmetra' , 'Torbjorn' , 'Tracer' , 'Widowmaker' , 'Rammatra'],
			'Playstyles': ['Front-Line' , 'Back-Line' , 'Assassin (Back-Line Invade)' , 'Rush-Down']
			}

		print('The OW2 randomizer is meant to be played on Open Queue, either in Ranked or in Quick Play. You will recieve a hero and playstyle to emulate. Some will be far easier than others while some will be far more fun than others. Good luck, have fun!')
		print(f'You will play {random.choice(Overwatch2["Heroes"])} playing as a {random.choice(Overwatch2["Playstyles"])}. Catchphrase!')
